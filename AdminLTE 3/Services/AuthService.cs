...
namespace AdminLTE.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(ApplicationDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
        {
            _context = context;
        ...
        public async Task<AuthModel> GetTokenAsync(TokenRequestModel model)
        {
            ...
            authModel.Permissons = _roleManager.GetClaimsAsync(rolesList[0]).Result.Select(c => c.Value).ToList();
